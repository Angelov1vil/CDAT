...
class MultiHeadAttentionLayer(nn.Module):
    ...
    def propagate_attention(self, g):
        ...
        g.send_and_recv(eids, fn.u_mul_e('F1', 'score', 'V_1'), fn.sum('V_1', 'T1'))
...
class GraphTransformerLayer(nn.Module):
    """
        Param: 
    """
    def __init__(self, in_dim, out_dim, num_heads, dropout=0.0, ffn=2, layer_norm=False, batch_norm=False, residual=False, use_bias=False):
        super().__init__()
